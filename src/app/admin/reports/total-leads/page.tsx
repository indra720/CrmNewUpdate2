...
function TotalLeadsPage() {
  ...
  const columns: ColumnDef<Lead>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const dateValue = row.getValue('updated_date') || row.original.created_date;
...
const TotalLeadsPageWrapper = () => (
  ...
  export default TotalLeadsPageWrapper;