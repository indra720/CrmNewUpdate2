...
const PendingFollowupsContent = () => {
  ...
  async function fetchLeads() {
    ...
    try {
      ...
      const data = await getTeamCustomerLeads('pending_follow', searchQuery, formattedStartDate, formattedEndDate); 
  ...
  useEffect(() => {
    fetchLeads();
  }, [page, searchQuery, startDate, endDate]); // Removed searchParams dependency
