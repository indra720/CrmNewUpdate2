  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 bg-card shadow-sm rounded-sm p-6">
        ...
        <div className="dashboard-card bg-gradient-to-r from-primary/10 via-card to-card border-2 border-primary/20 p-6 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-2 text-lg">Tower A, Sector 62, Noida, Uttar Pradesh 201301</p>
        ...
        {/* Map Placeholder */}
        <div className="dashboard-card p-0 overflow-hidden rounded-md shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-white shadow-lg p-3 rounded-sm ">
          ...
          <div className="dashboard-card  ">
            ...
            <div className="space-y-4">
              {checkInLocations.map((location, index) => (
                <div
                  key={location.id}
                  className={`p-4 rounded-xl border transition-colors animate-fade-in ${location.isCurrentLocation
                ...
                >
                    ...
                    <div className="flex flex-col  items-center gap-2">
                      ...
                      {location.isCurrentLocation && (
                        ...
                        <div className="flex items-center gap-2 " >
                          <span className="px-2 py-0.5 rounded-full  bg-primary/10 text-primary text-lg font-medium">
                          Current
                        </span>
                          <span className="text-muted-foreground text-lg">{location.distance}</span>
                        </div>
                        </>
                      )}
                    </div>
                  ...
                  <p className="text-lg font-bold text-muted-foreground mb-2 text-center">{location.address}</p>
          ...
          <div className="dashboard-card">
            ...
            <div className="space-y-3">
              {recentCheckIns.map((checkIn, index) => (
                <div
                  key={checkIn.id}
                  className="flex items-start gap-4 p-3 rounded-xl bg-muted/70 transition-colors animate-fade-in"
                  style={{ animationDelay: `${index * 0.05}s` }}
                >
                  ...
                  <div className="flex-1 min-w-0 ">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">{checkIn.coordinates}</p>
                  </div>
                </div>
              ))}
            </div>
